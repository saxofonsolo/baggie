...
describe("getElementSiblings", () => {
    test("Previous siblings", () => {
        ...
        expect(
            getElementSiblings(element3 as HTMLElement, {
    ...
    test("Next siblings", () => {
        ...
        expect(
            getElementSiblings(element2 as HTMLElement, {
    ...
    test("No siblings", () => {
        ...
        const element2 = document.getElementById("element-2");
        expect(getElementSiblings(element2 as HTMLElement)).toEqual([]);
    });
    ...
    test("No previous siblings", () => {
        ...
        expect(
            getElementSiblings(element1 as HTMLElement, {
    ...
    test("Until element using boolean", () => {
        ...
        expect(
            getElementSiblings(element3 as HTMLElement, {
                fromElement: element1 as HTMLElement,
                untilElement: true,
            }).length,
        ).toBe(2);
    });
    ...
    test("Match selector", () => {
        ...
        expect(
            getElementSiblings(target as HTMLElement, {
                matchSelector: ".a",
                includeOriginalElement: true,
            }).length,
        ).toBe(3);
