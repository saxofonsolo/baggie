import{j as e}from"./jsx-runtime-ffb262ed.js";import{r as d}from"./index-76fb7be0.js";import{b as x}from"./index-9f119f36.js";import{n as j}from"./normalizeRanges-f9fde636.js";import{I as u}from"./InputWrapper-a637f81f.js";import{u as p}from"./index-a1cf9e47.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-dbfea40b.js";import"../sb-preview/runtime.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";const f=(r,n)=>j(n).reduce((o,{from:a,to:c})=>o||r>=a&&r<=c,!1),l=r=>{const[n,o]=d.useState(r.number),[a,c]=d.useState(r.ranges),{realRanges:i,result:m}=d.useMemo(()=>{const s=a.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
...
//# sourceMappingURL=isInRange-81982b82.js.map
