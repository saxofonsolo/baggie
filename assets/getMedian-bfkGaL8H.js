import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{r as m}from"./index-4g5l5LRQ.js";import{b as c}from"./index-y2kHJEFa.js";import{g as h}from"./getMean-ZgQk-MLN.js";import{I as u}from"./InputWrapper-7qBv-a2h.js";import{useMDXComponents as l}from"./index-_VGcpBFS.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-WFQdlcL_.js";import"../sb-preview/runtime.js";import"./index-jmm5gWkb.js";import"./index-ogXoivrg.js";import"./index-MVbLLYTZ.js";import"./index-PPLHz8o0.js";import"./addNumbers-9N5IaDTs.js";function x(n){const t=n.length,s=Math.floor(t/2),o=[...n].sort((a,r)=>a-r);return t?t%2?o[s]:h([o[s-1],o[s]]):0}const i=n=>{const[t,s]=m.useState(n.defaultInput.join(", ")),{numbers:o,result:a}=m.useMemo(()=>{const r=t.split(/\s*,\s*/).filter(p=>p.length).map(p=>p.match(/^-?[0-9]*\.?[0-9]*$/)?parseFloat(p):NaN);return{numbers:r,result:x(r)}},[t]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(u,{label:"Input",labelForId:"input-input",children:e.jsx("input",{id:"input-input",value:t,onChange:({target:r})=>s(r.value)})}),e.jsx(u,{label:"Median",labelForId:void 0,children:e.jsx("div",{style:{padding:"5px 0"},children:isNaN(a)?"Error":a})})]}),e.jsx(c,{dark:!0,code:`
