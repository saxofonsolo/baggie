import{j as e}from"./jsx-runtime-ffb262ed.js";import{r as u}from"./index-76fb7be0.js";import{b}from"./index-2fa589e3.js";import{m as f}from"./mergeIntervals-da6ca95d.js";import{I as p}from"./InputWrapper-a637f81f.js";import{u as x}from"./index-a1cf9e47.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-862c386b.js";import"../sb-preview/runtime.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";import"./normalizeRanges-f9fde636.js";const y=(t,n,h=!0)=>f(n,h).reduce((s,{from:d,to:i})=>s>d&&s<i?[d,i].reduce((o,l)=>{const c=Math.abs(l-s),r=Math.abs(o-s);return c<=r?l:o}):s,t),m=t=>{const[n,h]=u.useState(t.number),[s,d]=u.useState(t.ranges),[i,o]=u.useState(!0),{realRanges:l,result:c}=u.useMemo(()=>{const r=s.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
...
//# sourceMappingURL=keepOutsideRange-dfcb4c7b.js.map
