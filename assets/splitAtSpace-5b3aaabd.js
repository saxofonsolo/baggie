import{j as e}from"./jsx-runtime-ffb262ed.js";import{r as c}from"./index-76fb7be0.js";import{b as u}from"./index-e3b36901.js";import{I as d}from"./InputWrapper-a637f81f.js";import{u as o}from"./index-a1cf9e47.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-d5d3edef.js";import"../sb-preview/runtime.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";const x=(n,s)=>{const r=n.trim(),t=Math.max(s,1),a=new RegExp(`[\\S]{${t},}|([\\S].{0,${t-1}}(?!\\S))`,"g");return r.match(a)||[r]},i=n=>{const[s,r]=c.useState(n.string),[t,a]=c.useState(n.nearestIndex),p=c.useMemo(()=>x(s,t),[s,t]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"10px"},children:[e.jsx(d,{label:"String",labelForId:"string-input",children:e.jsx("textarea",{id:"string-input",value:s,onChange:({target:l})=>r(l.value),style:{width:"100%",maxWidth:"360px"},spellCheck:!1,rows:3})}),e.jsx(d,{label:"Nearest index",labelForId:"nearest-index-input",children:e.jsx("input",{id:"nearest-index-input",value:t,type:"number",onChange:({target:l})=>a(l.valueAsNumber)})})]}),e.jsx(u,{dark:!0,code:`
...
`,e.jsx(i,{string:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur turpis sapien, pellentesque pulvinar scelerisque sit amet, iaculis ac sem. Pellentesque lacus nisi, sagittis eget felis at, elementum accumsan tortor.",nearestIndex:10})]})}}export{q as default};
//# sourceMappingURL=splitAtSpace-5b3aaabd.js.map
