import{j as e}from"./jsx-runtime-ffb262ed.js";import{b as j}from"./index-0081e355.js";import{r as d}from"./index-76fb7be0.js";import{I as h}from"./InputWrapper-a637f81f.js";import{u as m}from"./index-a1cf9e47.js";import"./iframe-3849f53d.js";import"../sb-preview/runtime.js";import"./index-d475d2ea.js";import"./_commonjsHelpers-de833af9.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";const p=(t,n,s)=>{const r=typeof s=="function"?s:a=>a,c=typeof t=="number"?t:r(t);return[...n].sort((a,o)=>Math.abs(c-r(a))-Math.abs(c-r(o)))},x=t=>{const[n,s]=d.useState(t.target),[r,c]=d.useState(t.numbers.join(", ")),{numbers:a,sorted:o}=d.useMemo(()=>{const i=r.split(/\s*,\s*/).filter(l=>l.length).map(l=>l.match(/^-?[0-9]*\.?[0-9]*$/)?parseFloat(l):NaN);return{numbers:i,sorted:p(n,i)}},[n,r]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(h,{label:"Target",labelForId:"target-input",children:e.jsx("input",{id:"target-input",type:"number",value:n,onChange:({target:i})=>s(i.valueAsNumber)})}),e.jsx(h,{label:"Numbers",labelForId:"numbers-input",children:e.jsx("input",{id:"numbers-input",value:r,onChange:({target:i})=>c(i.value)})}),e.jsx(h,{label:"Sorted",labelForId:void 0,children:e.jsxs("div",{style:{padding:"5px 0"},children:["[",o.join(", "),"]"]})})]}),e.jsx(j,{dark:!0,code:`
...
`})]})}}export{M as default};
//# sourceMappingURL=sortByDifference-2c75ccbf.js.map
