import{j as e}from"./jsx-runtime-CKrituN3.js";import{r as d}from"./index-CBqU2yxZ.js";import{b as x}from"./index-BI7qbVC1.js";import{n as j}from"./normalizeRanges-CV2ihbHB.js";import{I as u}from"./InputWrapper-BoKUP5ds.js";import{useMDXComponents as p}from"./index-C-_6Vi3R.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-BzcpQEgg.js";import"../sb-preview/runtime.js";import"./index-BtM5VmRH.js";import"./index-D2DNihGs.js";import"./index-Cmc67Rxs.js";import"./index-DrFu-skq.js";function f(r,n){return j(n).reduce((o,{from:a,to:c})=>o||r>=a&&r<=c,!1)}const l=r=>{const[n,o]=d.useState(r.number),[a,c]=d.useState(r.ranges),{realRanges:i,result:m}=d.useMemo(()=>{const s=a.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
