import{j as e}from"./jsx-runtime-94f6e698.js";import{r as m}from"./index-8db94870.js";import{b as j}from"./index-642316a4.js";import{m as b}from"./mergeIntervals-da6ca95d.js";import{I as h}from"./InputWrapper-088860b1.js";import{u as g}from"./index-1d576ef5.js";import"./_commonjsHelpers-042e6b4d.js";import"./iframe-bf4e6f48.js";import"../sb-preview/runtime.js";import"./index-d475d2ea.js";import"./index-80ae7d84.js";import"./index-d37d4223.js";import"./index-356e4a49.js";import"./normalizeRanges-f9fde636.js";const f=(r,s,i=!0)=>b(s,i).reduce((n,{from:o,to:d})=>n>o&&n<d?[o,d].reduce((c,l)=>{const u=Math.abs(l-n),t=Math.abs(c-n);return u<=t?l:c}):n,r),p=r=>{const[s,i]=m.useState(r.number),[n,o]=m.useState(r.ranges),[d,c]=m.useState(!0),{realRanges:l,result:u}=m.useMemo(()=>{const t=n.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
...
//# sourceMappingURL=keepOutsideRange-d5389f97.js.map
