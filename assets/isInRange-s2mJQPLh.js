import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{r as d}from"./index-4g5l5LRQ.js";import{b as x}from"./index-CJNtjuy4.js";import{n as j}from"./normalizeRanges-jULD8Ur9.js";import{I as u}from"./InputWrapper-7qBv-a2h.js";import{useMDXComponents as p}from"./index-_VGcpBFS.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-5P6ZPecu.js";import"../sb-preview/runtime.js";import"./index-jmm5gWkb.js";import"./index-ogXoivrg.js";import"./index-MVbLLYTZ.js";import"./index-PPLHz8o0.js";const f=(r,n)=>j(n).reduce((o,{from:a,to:c})=>o||r>=a&&r<=c,!1),l=r=>{const[n,o]=d.useState(r.number),[a,c]=d.useState(r.ranges),{realRanges:i,result:m}=d.useMemo(()=>{const s=a.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
