import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{r as p}from"./index-4g5l5LRQ.js";import{b as c}from"./index-y2kHJEFa.js";import{I as l}from"./InputWrapper-7qBv-a2h.js";import{useMDXComponents as d}from"./index-_VGcpBFS.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-WFQdlcL_.js";import"../sb-preview/runtime.js";import"./index-jmm5gWkb.js";import"./index-ogXoivrg.js";import"./index-MVbLLYTZ.js";import"./index-PPLHz8o0.js";function f(s){const r=s.reduce((n,t)=>(typeof n[t]>"u"?n[t]={value:t,frequency:1}:n[t].frequency+=1,n),{});return Object.values(r).map(({value:n,frequency:t})=>({value:n,frequency:t})).sort((n,t)=>n.frequency<t.frequency?-1:n.frequency>t.frequency?1:0).filter((n,t,u)=>n.frequency===u[0].frequency).reduce((n,t)=>({numbers:[...n.numbers,t.value],frequency:t.frequency}),{numbers:[],frequency:0})}const a=s=>{const[r,n]=p.useState(s.defaultInput.join(", ")),{numbers:t,result:u}=p.useMemo(()=>{const i=r.split(/\s*,\s*/).filter(o=>o.length).map(o=>o.match(/^-?[0-9]*\.?[0-9]*$/)?parseFloat(o):NaN);return{numbers:i,result:f(i)}},[r]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(l,{label:"Input",labelForId:"input-input",children:e.jsx("input",{id:"input-input",value:r,onChange:({target:i})=>n(i.value)})}),e.jsx(l,{label:"Output",labelForId:void 0,children:e.jsx("div",{style:{padding:"5px 0"},children:u?`[${u.numbers.join(", ")}]`:"Error"})})]}),e.jsx(c,{dark:!0,code:`
