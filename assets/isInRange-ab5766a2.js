import{j as e}from"./jsx-runtime-ffb262ed.js";import{r as d}from"./index-76fb7be0.js";import{b as g}from"./index-e3b36901.js";import{n as x}from"./normalizeRanges-f9fde636.js";import{I as u}from"./InputWrapper-a637f81f.js";import{u as h}from"./index-a1cf9e47.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-d5d3edef.js";import"../sb-preview/runtime.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";const j=(r,t)=>x(t).reduce((a,{from:n,to:c})=>a||r>=n&&r<=c,!1),o=r=>{const[t,a]=d.useState(r.number),[n,c]=d.useState(r.ranges),{realRanges:l,result:m}=d.useMemo(()=>{const i=n.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
...
// result = ${m?"true":"false"}
`})]})};try{o.displayName="Example",o.__docgenInfo={description:"",displayName:"Example",props:{number:{defaultValue:null,description:"",name:"number",required:!0,type:{name:"number"}},ranges:{defaultValue:null,description:"",name:"ranges",required:!0,type:{name:"string"}}}}}catch{}function k(r={}){const{wrapper:t}=Object.assign({},h(),r.components);return t?e.jsx(t,Object.assign({},r,{children:e.jsx(a,{})})):a();function a(){const n=Object.assign({h1:"h1",p:"p",code:"code",h2:"h2",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",strong:"strong"},h(),r.components);return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"isinrange",children:"isInRange"}),`
...
[10, 20]
{ from: 25, to: 75 }`})]})}}export{k as default};
//# sourceMappingURL=isInRange-ab5766a2.js.map
