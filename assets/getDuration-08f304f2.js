import{j as e}from"./jsx-runtime-ffb262ed.js";import{r as l}from"./index-76fb7be0.js";import{b as u}from"./index-e3b36901.js";import{I as c}from"./InputWrapper-a637f81f.js";import{u as o}from"./index-a1cf9e47.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-d5d3edef.js";import"../sb-preview/runtime.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";const h=(n,s)=>s/n,r=n=>{const[s,i]=l.useState(n.speed),[t,p]=l.useState(n.distance),d=l.useMemo(()=>h(s,t),[s,t]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(c,{label:"Speed",labelForId:"speed-input",children:e.jsx("input",{id:"speed-input",type:"number",value:s,onChange:({target:a})=>i(a.valueAsNumber)})}),e.jsx(c,{label:"Distance",labelForId:"distance-input",children:e.jsx("input",{id:"distance-input",type:"number",value:t,onChange:({target:a})=>p(a.valueAsNumber)})}),e.jsx(c,{label:"Duration",labelForId:void 0,children:e.jsx("div",{style:{padding:"5px 0"},children:isNaN(d)?"Error":d})})]}),e.jsx(u,{dark:!0,code:`
...
`,e.jsx(r,{speed:1,distance:100})]})}}export{I as default};
//# sourceMappingURL=getDuration-08f304f2.js.map
