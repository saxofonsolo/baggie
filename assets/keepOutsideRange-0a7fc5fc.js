import{j as e}from"./jsx-runtime-ffb262ed.js";import{r as m}from"./index-76fb7be0.js";import{b as j}from"./index-e3b36901.js";import{m as b}from"./mergeIntervals-da6ca95d.js";import{I as p}from"./InputWrapper-a637f81f.js";import{u as g}from"./index-a1cf9e47.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-d5d3edef.js";import"../sb-preview/runtime.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";import"./normalizeRanges-f9fde636.js";const f=(r,s,i=!0)=>b(s,i).reduce((n,{from:o,to:d})=>n>o&&n<d?[o,d].reduce((c,l)=>{const u=Math.abs(l-n),t=Math.abs(c-n);return u<=t?l:c}):n,r),h=r=>{const[s,i]=m.useState(r.number),[n,o]=m.useState(r.ranges),[d,c]=m.useState(!0),{realRanges:l,result:u}=m.useMemo(()=>{const t=n.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
`).map(a=>{try{return JSON.parse(a.replace(/["`']/g,"").replace(/([a-z]+)/g,'"$1"'))}catch{return}}).filter(a=>a&&(Array.isArray(a)&&a.length===2||typeof a=="object"&&typeof a.from=="number"&&typeof a.to=="number")),x=f(s,t,d);return{realRanges:t,result:x}},[s,n,d]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(p,{label:"Number",labelForId:"number-input",children:e.jsx("input",{id:"number-input",type:"number",value:s,onChange:({target:t})=>i(t.valueAsNumber||0),autoComplete:"off"})}),e.jsx(p,{label:"Ranges",labelForId:"ranges-input",children:e.jsx("textarea",{id:"ranges-input",value:n,onChange:({target:t})=>o(t.value),style:{width:"100%",maxWidth:"360px"},autoComplete:"off",rows:3})}),e.jsx(p,{label:"Result",labelForId:void 0,children:e.jsx("div",{style:{padding:"5px 0"},children:u})})]}),e.jsxs("label",{children:[e.jsx("input",{type:"checkbox",checked:d,onChange:()=>c(t=>!t)})," ","Combine equals"]}),e.jsx(j,{dark:!0,code:`
...
// result = ${u}
`})]})};try{h.displayName="Example",h.__docgenInfo={description:"",displayName:"Example",props:{number:{defaultValue:null,description:"",name:"number",required:!0,type:{name:"number"}},ranges:{defaultValue:null,description:"",name:"ranges",required:!0,type:{name:"string"}}}}}catch{}function F(r={}){const{wrapper:s}=Object.assign({},g(),r.components);return s?e.jsx(s,Object.assign({},r,{children:e.jsx(i,{})})):i();function i(){const n=Object.assign({h1:"h1",p:"p",h2:"h2",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",strong:"strong",code:"code"},g(),r.components);return e.jsxs(e.Fragment,{children:[e.jsx(n.h1,{id:"keepoutsiderange",children:"keepOutsideRange"}),`
...
`,e.jsx(h,{number:30,ranges:"{ from: 25, to: 75 }"}),`
`,e.jsx(n.p,{children:"Keep number outside multiple ranges"}),`
`,e.jsx(h,{number:10,ranges:`[0, 10]
[10, 20]
{ from: 25, to: 75 }`})]})}}export{F as default};
//# sourceMappingURL=keepOutsideRange-0a7fc5fc.js.map
