import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{r as d}from"./index-4g5l5LRQ.js";import{b as x}from"./index-CJNtjuy4.js";import{I as c}from"./InputWrapper-7qBv-a2h.js";import{useMDXComponents as m}from"./index-_VGcpBFS.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-5P6ZPecu.js";import"../sb-preview/runtime.js";import"./index-jmm5gWkb.js";import"./index-ogXoivrg.js";import"./index-MVbLLYTZ.js";import"./index-PPLHz8o0.js";const j=(r,t)=>{const i=t||new Date,n=new Date(r),a=i.getMonth()-n.getMonth();let s=i.getFullYear()-n.getFullYear();return(a<0||a===0&&i.getDate()<n.getDate())&&s--,s},l=r=>{const[t,i]=d.useState(r.birth),[n,a]=d.useState(r.death),s=new Date(t).toISOString().replace(/\.[0-9]+Z$/,""),g=n?new Date(n).toISOString().replace(/\.[0-9]+Z$/,""):"",p=d.useMemo(()=>j(t,n),[t,n]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(c,{label:"Birth",labelForId:"birth-input",children:e.jsx("input",{id:"birth-input",type:"datetime-local",value:s,onChange:({target:o})=>i(new Date(o.valueAsNumber))})}),e.jsx(c,{label:"To time",labelForId:"to-input",children:e.jsx("input",{id:"to-input",type:"datetime-local",value:g,onChange:({target:o})=>a(new Date(o.valueAsNumber))})})]}),e.jsx(x,{dark:!0,code:`
...
`,e.jsx(l,{birth:new Date("1986-06-17"),death:new Date("2023-06-17")})]})}function $(r={}){const{wrapper:t}=Object.assign({},m(),r.components);return t?e.jsx(t,Object.assign({},r,{children:e.jsx(h,r)})):h(r)}export{$ as default};
