import{j as e}from"./jsx-runtime-ffb262ed.js";import{r as i}from"./index-76fb7be0.js";import{b as I}from"./index-e3b36901.js";import{g as E}from"./getPercentage-4c125d06.js";import{I as h}from"./InputWrapper-a637f81f.js";import{u as m}from"./index-a1cf9e47.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-d5d3edef.js";import"../sb-preview/runtime.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";const o=s=>{const[n,d]=i.useState(s.part),[t,f]=i.useState(s.percentage),[l,b]=i.useState(s.whole),[c,y]=i.useState(!0),[w,P,$]=i.useMemo(()=>{const r=typeof n=="number",p=typeof t=="number",j=typeof l=="number",v=r&&`const part = ${n};`,C=p&&`const percentage = ${t};`,_=j&&`const whole = ${l};`,a=E({part:n,percentage:t,whole:l},c),g=(p?t:a)*(c?100:1),x=c?"":", false",D=!r&&`
...
`,e.jsxs(t.p,{children:["Calculate Z when ",e.jsx(t.strong,{children:"X of Y is Z%"})]}),`
`,e.jsx(o,{part:5,whole:50})]})}}export{Y as default};
//# sourceMappingURL=getPercentage-6f9f0ed1.js.map
