import{j as e}from"./jsx-runtime-ffb262ed.js";import{r as d}from"./index-76fb7be0.js";import{b as g}from"./index-0081e355.js";import{n as x}from"./normalizeRanges-f9fde636.js";import{I as u}from"./InputWrapper-a637f81f.js";import{u as h}from"./index-a1cf9e47.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-3849f53d.js";import"../sb-preview/runtime.js";import"./index-d475d2ea.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";const j=(r,t)=>x(t).reduce((a,{from:n,to:c})=>a||r>=n&&r<=c,!1),o=r=>{const[t,a]=d.useState(r.number),[n,c]=d.useState(r.ranges),{realRanges:l,result:m}=d.useMemo(()=>{const i=n.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
...
//# sourceMappingURL=isInRange-7474c9e6.js.map
