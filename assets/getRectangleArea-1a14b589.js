import{j as e}from"./jsx-runtime-ffb262ed.js";import{r as l}from"./index-76fb7be0.js";import{b as p}from"./index-0081e355.js";import{I as d}from"./InputWrapper-a637f81f.js";import{u as c}from"./index-a1cf9e47.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-3849f53d.js";import"../sb-preview/runtime.js";import"./index-d475d2ea.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";const h=(n,r)=>n*r,o=n=>{const[r,a]=l.useState(n.x),[t,x]=l.useState(n.y),s=l.useMemo(()=>h(r,t),[r,t]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(d,{label:"X",labelForId:"x-input",children:e.jsx("input",{id:"x-input",type:"number",value:r,onChange:({target:i})=>a(i.valueAsNumber)})}),e.jsx(d,{label:"Y",labelForId:"x-input",children:e.jsx("input",{id:"y-input",type:"number",value:t,onChange:({target:i})=>x(i.valueAsNumber)})}),e.jsx(d,{label:"Surface area",labelForId:void 0,children:e.jsx("div",{style:{padding:"5px 0"},children:isNaN(s)?"Error":s})})]}),e.jsxs("div",{style:{aspectRatio:`${Math.abs(r)} / ${Math.abs(t)}`,background:"#FC0",width:Math.abs(r)>=Math.abs(t)?"150px":`${Math.abs(r)/Math.abs(t)*150}px`,height:Math.abs(r)<=Math.abs(t)?"150px":`${Math.abs(t)/Math.abs(r)*150}px`,marginTop:"20px",position:"relative",display:"inline-block",pointerEvents:"none",userSelect:"none",transition:"all .4s ease-out"},children:[e.jsx("div",{style:{position:"absolute",inset:"2px",background:`repeating-linear-gradient(
                            -45deg,
                            #900,
                            #900 2px,
                            #FC0 2px,
...
//# sourceMappingURL=getRectangleArea-1a14b589.js.map
