import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{r as i}from"./index-4g5l5LRQ.js";import{b as E}from"./index-y2kHJEFa.js";import{g as F}from"./getPercentage--idX-fA0.js";import{I as d}from"./InputWrapper-7qBv-a2h.js";import{useMDXComponents as m}from"./index-_VGcpBFS.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-WFQdlcL_.js";import"../sb-preview/runtime.js";import"./index-jmm5gWkb.js";import"./index-ogXoivrg.js";import"./index-MVbLLYTZ.js";import"./index-PPLHz8o0.js";const o=n=>{const[t,f]=i.useState(n.part),[s,b]=i.useState(n.percentage),[l,y]=i.useState(n.whole),[c,w]=i.useState(!0),[P,$,v]=i.useMemo(()=>{const r=typeof t=="number",h=typeof s=="number",j=typeof l=="number",C=r&&`const part = ${t};`,_=h&&`const percentage = ${s};`,D=j&&`const whole = ${l};`,a=F({part:t,percentage:s,whole:l},c),p=(h?s:a)*(c?100:1),g=c?"":", false",S=!r&&`
