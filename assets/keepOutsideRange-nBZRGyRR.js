import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{r as u}from"./index-4g5l5LRQ.js";import{b}from"./index-y2kHJEFa.js";import{m as f}from"./mergeIntervals-oG_OIwaV.js";import{I as p}from"./InputWrapper-7qBv-a2h.js";import{useMDXComponents as x}from"./index-_VGcpBFS.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-WFQdlcL_.js";import"../sb-preview/runtime.js";import"./index-jmm5gWkb.js";import"./index-ogXoivrg.js";import"./index-MVbLLYTZ.js";import"./index-PPLHz8o0.js";import"./normalizeRanges-Tq3FrBIg.js";function y(t,n,h=!0){return f(n,h).reduce((s,{from:d,to:i})=>s>d&&s<i?[d,i].reduce((o,l)=>{const c=Math.abs(l-s),r=Math.abs(o-s);return c<=r?l:o}):s,t)}const m=t=>{const[n,h]=u.useState(t.number),[s,d]=u.useState(t.ranges),[i,o]=u.useState(!0),{realRanges:l,result:c}=u.useMemo(()=>{const r=s.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
...
[10, 20]
{ from: 25, to: 75 }`})]})}function D(t={}){const{wrapper:n}=Object.assign({},x(),t.components);return n?e.jsx(n,Object.assign({},t,{children:e.jsx(g,t)})):g(t)}export{D as default};
