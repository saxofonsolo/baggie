import{j as e}from"./jsx-runtime-ffb262ed.js";import{r as u}from"./index-76fb7be0.js";import{b as c}from"./index-9f119f36.js";import{I as l}from"./InputWrapper-a637f81f.js";import{u as m}from"./index-a1cf9e47.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-dbfea40b.js";import"../sb-preview/runtime.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";const x=n=>{const t={};let s=0,o=[];return n.forEach(r=>{t[r]=(t[r]||0)+1,s<t[r]?(s=t[r],o=[r]):s===t[r]&&o.push(r)}),{numbers:o,frequency:s}},a=n=>{const[t,s]=u.useState(n.defaultInput.join(", ")),{numbers:o,result:r}=u.useMemo(()=>{const i=t.split(/\s*,\s*/).filter(p=>p.length).map(p=>p.match(/^-?[0-9]*\.?[0-9]*$/)?parseFloat(p):NaN);return{numbers:i,result:x(i)}},[t]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(l,{label:"Input",labelForId:"input-input",children:e.jsx("input",{id:"input-input",value:t,onChange:({target:i})=>s(i.value)})}),e.jsx(l,{label:"Output",labelForId:void 0,children:e.jsx("div",{style:{padding:"5px 0"},children:r?`[${r.numbers.join(", ")}]`:"Error"})})]}),e.jsx(c,{dark:!0,code:`
...
//# sourceMappingURL=getMode-bc0bc0ce.js.map
