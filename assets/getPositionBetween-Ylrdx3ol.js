import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{r as l}from"./index-4g5l5LRQ.js";import{b as h}from"./index-6Pv_FbVv.js";import{g}from"./getPositionBetween-RxTUMZ_D.js";import{I as a}from"./InputWrapper-7qBv-a2h.js";import{u as m}from"./index-Dbo06S9W.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-gHzccT4x.js";import"../sb-preview/runtime.js";import"./index-g30A4r-R.js";import"./index-aKxH7ZY0.js";import"./index-PPLHz8o0.js";const o=n=>{const[t,p]=l.useState(n.from),[i,u]=l.useState(n.to),[s,x]=l.useState(n.percentage),c=l.useMemo(()=>g(t,i,s),[t,i,s]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(a,{label:"From",labelForId:"from-input",children:e.jsx("input",{id:"from-input",type:"number",value:t,onChange:({target:r})=>p(r.valueAsNumber||0)})}),e.jsx(a,{label:"To",labelForId:"to-input",children:e.jsx("input",{id:"to-input",type:"number",value:i,onChange:({target:r})=>u(r.valueAsNumber||0)})}),e.jsx(a,{label:"Percentage",labelForId:"percentage-input",children:e.jsx("input",{id:"percentage-input",type:"number",value:s,onChange:({target:r})=>x(r.valueAsNumber||0)})}),e.jsx(a,{label:"Position",labelForId:void 0,children:e.jsx("div",{style:{padding:"5px 0"},children:c})})]}),e.jsx(h,{dark:!0,code:`
...
//# sourceMappingURL=getPositionBetween-Ylrdx3ol.js.map
