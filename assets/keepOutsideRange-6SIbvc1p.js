import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{r as u}from"./index-4g5l5LRQ.js";import{b}from"./index-XmUqo-P7.js";import{m as f}from"./mergeIntervals-0VEuZGY-.js";import{I as p}from"./InputWrapper-7qBv-a2h.js";import{u as x}from"./index-Dbo06S9W.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-aAGjdgm-.js";import"../sb-preview/runtime.js";import"./index-g30A4r-R.js";import"./index-aKxH7ZY0.js";import"./index-PPLHz8o0.js";import"./normalizeRanges-jULD8Ur9.js";const y=(t,n,h=!0)=>f(n,h).reduce((s,{from:d,to:i})=>s>d&&s<i?[d,i].reduce((o,l)=>{const c=Math.abs(l-s),r=Math.abs(o-s);return c<=r?l:o}):s,t),m=t=>{const[n,h]=u.useState(t.number),[s,d]=u.useState(t.ranges),[i,o]=u.useState(!0),{realRanges:l,result:c}=u.useMemo(()=>{const r=s.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
...
//# sourceMappingURL=keepOutsideRange-6SIbvc1p.js.map
