import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{r as u}from"./index-4g5l5LRQ.js";import{b}from"./index-CJNtjuy4.js";import{m as f}from"./mergeIntervals-0VEuZGY-.js";import{I as p}from"./InputWrapper-7qBv-a2h.js";import{useMDXComponents as x}from"./index-_VGcpBFS.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-5P6ZPecu.js";import"../sb-preview/runtime.js";import"./index-jmm5gWkb.js";import"./index-ogXoivrg.js";import"./index-MVbLLYTZ.js";import"./index-PPLHz8o0.js";import"./normalizeRanges-jULD8Ur9.js";const y=(t,n,h=!0)=>f(n,h).reduce((s,{from:d,to:i})=>s>d&&s<i?[d,i].reduce((o,l)=>{const c=Math.abs(l-s),r=Math.abs(o-s);return c<=r?l:o}):s,t),m=t=>{const[n,h]=u.useState(t.number),[s,d]=u.useState(t.ranges),[i,o]=u.useState(!0),{realRanges:l,result:c}=u.useMemo(()=>{const r=s.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
