import{j as e}from"./jsx-runtime-ffb262ed.js";import{r as m}from"./index-76fb7be0.js";import{b as j}from"./index-0081e355.js";import{m as b}from"./mergeIntervals-da6ca95d.js";import{I as h}from"./InputWrapper-a637f81f.js";import{u as g}from"./index-a1cf9e47.js";import"./_commonjsHelpers-de833af9.js";import"./iframe-3849f53d.js";import"../sb-preview/runtime.js";import"./index-d475d2ea.js";import"./index-ffc7e5ff.js";import"./index-d37d4223.js";import"./index-356e4a49.js";import"./normalizeRanges-f9fde636.js";const f=(r,s,i=!0)=>b(s,i).reduce((n,{from:o,to:d})=>n>o&&n<d?[o,d].reduce((c,l)=>{const u=Math.abs(l-n),t=Math.abs(c-n);return u<=t?l:c}):n,r),p=r=>{const[s,i]=m.useState(r.number),[n,o]=m.useState(r.ranges),[d,c]=m.useState(!0),{realRanges:l,result:u}=m.useMemo(()=>{const t=n.replace(/][^[{]+/g,`]
`).replace(/}[^[{]+/g,`}
`).split(`
...
//# sourceMappingURL=keepOutsideRange-4151389a.js.map
