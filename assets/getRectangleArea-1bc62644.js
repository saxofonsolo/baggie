import{j as e}from"./jsx-runtime-94f6e698.js";import{r as l}from"./index-8db94870.js";import{b as p}from"./index-21461081.js";import{I as d}from"./InputWrapper-088860b1.js";import{u as c}from"./index-1d576ef5.js";import"./_commonjsHelpers-042e6b4d.js";import"./iframe-bde67206.js";import"../sb-preview/runtime.js";import"./index-d475d2ea.js";import"./index-80ae7d84.js";import"./index-d37d4223.js";import"./index-356e4a49.js";const h=(n,r)=>n*r,o=n=>{const[r,a]=l.useState(n.x),[t,x]=l.useState(n.y),s=l.useMemo(()=>h(r,t),[r,t]);return e.jsxs(e.Fragment,{children:[e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(d,{label:"X",labelForId:"x-input",children:e.jsx("input",{id:"x-input",type:"number",value:r,onChange:({target:i})=>a(i.valueAsNumber)})}),e.jsx(d,{label:"Y",labelForId:"x-input",children:e.jsx("input",{id:"y-input",type:"number",value:t,onChange:({target:i})=>x(i.valueAsNumber)})}),e.jsx(d,{label:"Surface area",labelForId:void 0,children:e.jsx("div",{style:{padding:"5px 0"},children:isNaN(s)?"Error":s})})]}),e.jsxs("div",{style:{aspectRatio:`${Math.abs(r)} / ${Math.abs(t)}`,background:"#FC0",width:Math.abs(r)>=Math.abs(t)?"150px":`${Math.abs(r)/Math.abs(t)*150}px`,height:Math.abs(r)<=Math.abs(t)?"150px":`${Math.abs(t)/Math.abs(r)*150}px`,marginTop:"20px",position:"relative",display:"inline-block",pointerEvents:"none",userSelect:"none",transition:"all .4s ease-out"},children:[e.jsx("div",{style:{position:"absolute",inset:"2px",background:`repeating-linear-gradient(
                            -45deg,
                            #900,
                            #900 2px,
                            #FC0 2px,
...
//# sourceMappingURL=getRectangleArea-1bc62644.js.map
